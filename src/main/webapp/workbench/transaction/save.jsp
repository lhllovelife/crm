...
<body>
	...
	<form class="form-horizontal" role="form" id="tranForm" action="workbench/transaction/save.do" method="post" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activityName" value="发传单1">
				<input type="hidden" id="create-activityId" value="868ea1af2de24d9490ae3827751ec198" name="activityId"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" id="create-contactsId" value="bb94714073034f2db726b510a515b69c" name="contactsId">
			</div>
		</div>
